...
from pythae.models import BetaVAEConfig, BetaVAE, VAEConfig, VAE, BetaTCVAEConfig, BetaTCVAE
...
model = BetaTCVAE(model_config=model_config, encoder=encoder, decoder=decoder).to("cuda:0")
...
training_config = BaseTrainerConfig(
    output_dir='res_betatcvae_new_dSprites_v2',
